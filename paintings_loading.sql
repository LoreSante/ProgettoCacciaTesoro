...
VALUES ('Putto che suona',
        ...
        'È stato a lungo ritenuto opera a sé stante, finché col restauro del 2000 le riflettografie rivelarono che si tratta forse di un frammento di una pala di maggiori dimensioni. Lo sfondo scuro nasconde infatti le incisioni parallele del disegno di alcuni gradini, su cui l''angelo stava seduto, probabilmente ai pedi di un trono della Vergine col Bambino.',
        'https://upload.wikimedia.org/wikipedia/commons/thumb/9/9e/Rosso_Fiorentino_-_Madonna_dello_Spedalingo_-_Google_Art_Project.jpg/2560px-Rosso_Fiorentino_-_Madonna_dello_Spedalingo_-_Google_Art_Project.jpg',
        'Il Rosso, sia di nome che di colore');

INSERT INTO `paintings`( `title`, `author`, `year`, `technique`, `position`, `description`, `url`, `riddle`)
VALUES ('L''incoronazione di Napoleone',
        'Jacques-Louis David',
        '1805-1807',
        'Olio su tela',
